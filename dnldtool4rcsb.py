...
This Python script downloads files (PDB and SDF) with atomic coordinates from
...
protein target for which binding is available. It employs a requests library for
 downloading the atomic coordinates from the RCSB.

This code has the following
rcsb_download_sdf: This function downloads a specific ligand from the PDB using
the RCSB Model Server API and saves it as an SD File.

scrape_data_rcsb: This function scrapes data from the RCSB page. It saves it to a
file with the identification of the active ligand found in a given structure.
