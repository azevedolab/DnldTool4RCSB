...
employs the Requests HTTP library for downloading the atomic coordinates from
the RCSB (Veit-Acosta & de Azevedo, 2021).
...
To install the Requests HTTP library, type the following command.
